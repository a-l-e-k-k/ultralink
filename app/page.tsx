...
import { ArrowRight, Link, Server, Zap, Menu, X } from 'lucide-react';
...
const LandingPage = () => {
  ...
  return (
    <div className="min-h-screen bg-black text-white overflow-hidden">
      <header className={`fixed w-full z-50 transition-all duration-300 ${scrollPosition > 50 ? 'bg-black/80 backdrop-blur-md' : 'bg-transparent'}`}>
